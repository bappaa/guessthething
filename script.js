...
const isTouchDevice = () => {
    try{
        //we try to create Touch Event (it would fail fr desktops and throw error)
...
const drop = (e) => {
    ...
    if (isTouchDevice()) {
        ...
        //if the position of flag falls inside the bound of the country name
        if(
            ...
            currentDrop.insertAdjacentElement(
                "afterbegin",
